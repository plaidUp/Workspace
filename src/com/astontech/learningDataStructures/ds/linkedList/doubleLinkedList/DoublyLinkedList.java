...
public class DoublyLinkedList {
    ...
    public void insertFirst(int data){
        ...
        newNode.next = first;   // the new node's next filed wil point ot he old first
        this.first = newNode;
    }
    ...
    public void insertLast(int data) {
        ...
        if(isEmpty()){
            first = newNode;     // if empty, last will refer to the new node being created
        } else {
    ...
    public boolean insertAfter(int key, int data){
        ...
        if(current == last){
            ...
            newNode.next = current.next;    // the node's next field should point to the node ahead of the current node
